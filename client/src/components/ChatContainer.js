...
export default function ChatContainer() {
  ...
  return (
    <div>
        ...
        user ?
         ...
         <div style={{display:'flex', flexDirection:"row", justifyContent: 'space-between'}} >
          <h4>Username: {user}</h4>
          <strong>Remember to watch   <a href='https://github.com/jani358'> My GitHub</a></strong>
    ...
    <small style={{backgroundColor:'lightblue' , padding:5 , borderRadius:5}} ><strong> #Janindu- Remember the name  </strong></small>
